...
public class WeekSetup {
    ...
    public List<String> toList() {
        ...
        list.add(planName);
        list.add(objectiveTitle);
        list.add(objectiveDescription);
        list.add(materialTopic);
        list.add(materialFormat);
        list.add(goal);
        list.add(reminderTitle);
        list.add(reminderDescription);
        list.add(mainTaskTitle);
        list.add(mainHabit);
        list.add(mainCardStudy);
        return list;
    }
